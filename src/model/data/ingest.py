...
def ingest() -> dict:
    cfg.DATASET_RAW_PATH.mkdir(parents=True, exist_ok=True)
    ...
    train_dst = cfg.DATASET_RAW_PATH / cfg.KAGGLE_DATASET_TRAIN_FILENAME
    test_dst = cfg.DATASET_RAW_PATH / cfg.KAGGLE_DATASET_TEST_FILENAME
...
def main():
    with mlflow.start_run(run_name="data_ingest"):
        ...
        mlflow.log_param(
            "train_path", cfg.DATASET_RAW_PATH / cfg.KAGGLE_DATASET_TRAIN_FILENAME
        )
        mlflow.log_param(
            "test_path", cfg.DATASET_RAW_PATH / cfg.KAGGLE_DATASET_TEST_FILENAME
        )
